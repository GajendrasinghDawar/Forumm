...
export function NavBar({ user }) {
    return (
        <header
            className="bg-sand-sand2 sticky top-0 z-10 backdrop-blur-lg bg-opacity-50 "
        >
            <nav className="max-w-7xl md:mx-auto px-4 sm:px-6 lg:px-8 ml-auto h-16 w-full flex justify-between md:grid  md:grid-cols-7  md:grid-flow-col-dense">
                ...
                <section className="md:col-start-7  md:col-end-8 ">
                        ...
                        { user && !(user.email_verified_at === null) && (
                            <>
                                <Link
                                    ...
                                    className={ `rounded-lg p-1 bg-gray-gray3  hover:bg-gray-gray4 border border-gray-gray5 inline-flex justify-center items-center  font-medium text-sand-sand11 min-h-[30px] min-w-fit ` }
                                >
                                    <PlusIcon />
                                    <span className="ml-1"
                                    >
